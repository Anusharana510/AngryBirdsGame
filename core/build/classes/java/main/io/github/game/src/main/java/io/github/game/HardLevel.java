...
public class HardLevel implements Screen {
    ...
    public void show() {
        ...
        backgroundTexture = new Texture("hardbg.png");
        ...
        stage.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                ...
                if (x >= 50 && x <= 150 && y >= Gdx.graphics.getHeight() - 50 && y <= Gdx.graphics.getHeight()) {
                    // Pass both game and the current screen (HardLevel.this) to PauseScreen
                    game.setScreen(new PauseScreen(game, HardLevel.this));
                }
            }
        });
    }
